...
#include <ATen/cuda/CUDAContext.h>      // AT_CUDA_CHECK
#include <c10/util/Exception.h>         // TORCH_CHECK / TORCH_CHECK_EQ
...
#define TORCH_CHECK_EQ(val1, val2) TORCH_CHECK((val1) == (val2))
#endif
